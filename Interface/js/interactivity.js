...
draggableDiv.style.cssText= "width:370px; height:150px; font-family:'Geneva'; cursor:grab; position:absolute; text-align:center; z-index:1000; top: 150px;";
let isBlue = true;

var display = document.createElement('h1');
data.port.on("time_spent", function(message){
    display.textContent = message;
})
display.setAttribute("id","displayText");
display.style.cssText = "opacity: 0.5; color:Blue; font-size: 150px; font-weight:400;"
...
function whiteText() {
    isBlue = false;
    display.style.cssText = "opacity: 0.5; color:White; font-size: 150px; font-weight:400;"
