...
var styles = 
	...
	+ " #draggableDiv { position: fixed; background-color: rgba(245, 245, 245, 0.7); top: 0; right: 0; bottom: 0; left: 0; width: 100%; height: 100%;}"
	+ " #Layer_1 { position: fixed; margin: auto; top: 0; right: 0; bottom: 0; left: 0; width: 75%; height: 75%;}"
	+ " .qText { font-family: 'PT Sans', sans-serif; font-size: 15pt; }"
	+ " #webName { font-size: 35pt; }"
	+ " #rWstroke, #yButton, #nButton { fill: #FFFFFF; }"
	+ " #qMarkFill, #qMarkStroke, #rWfill { fill: #666666; }"
	+ " #questionWrapper { fill: none; }"

	+ "#yStroke, #nStroke { stroke: #FFFFFF; fill: none; stroke-width: 2; stroke-miterlimit: 10; width: 139; height: 57;} "
	+ "#SVGID_1_ { stroke: #666666; fill: #FFFFFF; stroke-width: 2; stroke-miterlimit: 10; }"
	+ ".NOt { fill : #993300; } "
	+ ".YESt { fill : #006699; } "
...
document.body.appendChild(draggableDiv);
    ...
    draggableDiv.appendChild(Layer_1);
        ...
        Layer_1.appendChild(SVGID_5_);
            ...
            u.setAttributeNS('http://www.w3.org/1999/xlink','href', '#SVGID_4_');
        ...
        //yButton.setAttribute('onclick', 'yesClick(evt)')
	...
	document.getElementById('nButton').onclick =
		function() {
